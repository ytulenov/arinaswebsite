...
```math
\text{IMDB\_Rating} = \beta_0 + \beta_1\text{Released\_Year} + \beta_2\text{Runtime} + \beta_3\text{First\_Genre} + \beta_4\text{No\_of\_Votes} + \beta_5\text{Log\_Gross} + \beta_6\text{Certificate} + \beta_7\text{Director} + \beta_8\text{Star1} + \epsilon
```

The estimated model that we obtained was, 

```math
\text{IMDB\_Rating} = 22.52^{*} - 0.007\,\text{Released\_Year}^{*} + 0.003\,\text{Runtime}^{*} + \beta_3\text{First\_Genre} + 0.00\,\text{No\_of\_Votes}^{*} + 0.003\,\text{Log\_Gross} + \beta_6\text{Certificate} + \beta_7\text{Director} + \beta_8\text{Star1} + \epsilon
```
...
```math
22.52 - 0.007(2014) + 0.003(200) + 0.168 + 0.003\log(400{,}000) + 0.076 - 1.77 + 0.691 = 8.2
```
